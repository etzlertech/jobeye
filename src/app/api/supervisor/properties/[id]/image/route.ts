...
export async function POST(
  ...
  try {
    ...
    console.log('Image upload API called for property:', propertyId, 'tenant:', tenantId, 'Source:', context.source);
    ...
    for (const size of sizes) {
      ...
      const fileName = `properties/${propertyId}/${timestamp}-${size.name}.jpg`;
    ...
    console.log('Updating property with URLs:', imageUrls);
