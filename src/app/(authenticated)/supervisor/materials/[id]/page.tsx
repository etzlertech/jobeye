...
export default function MaterialDetailPage() {
  ...
  const loadItem = async () => {
    try {
      ...
      if (!response.ok) throw new Error(data.message || 'Failed to load material');
      ...
      <div className="mobile-container">
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-lg">Loading material...</p>
          </div>
        </div>
        <style jsx>{`
          .mobile-container {
      ...
      <div className="mobile-container">
        ...
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-lg">{error || 'Material not found'}</p>
            <button
  ...
  return (
    <div className="mobile-container">
          ...
          <div className="detail-section">
            ...
            <div className="space-y-2">
              <div>
                ...
                <p className="detail-value">{item.current_quantity} {item.unit_of_measure}</p>
              </div>
              {item.min_quantity && (
                <div>
                  <label className="detail-label">Minimum Quantity</label>
                  <p className="detail-value">{item.min_quantity} {item.unit_of_measure}</p>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="bottom-actions">
        ...
        <button
          type="button"
          onClick={() => router.push(`/supervisor/materials/${itemId}/edit`)}
