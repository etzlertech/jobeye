      ...
      <div className="mobile-container">
        ...
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-lg">{error || 'Vehicle not found'}</p>
            <button
    ...
    <div className="mobile-container">
      ...
      <div className="header-bar">
        <div>
          ...
          <p className="text-xs text-gray-500 capitalize">{item.attributes?.vehicle_type || 'Vehicle'}</p>
        </div>
        <Truck className="w-6 h-6" style={{ color: '#FFD700' }} />
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 pb-4 space-y-4">
          ...
          <div className="detail-section">
            <h3 className="detail-section-title">Vehicle Details</h3>
            <div className="space-y-2">
              ...
              {item.attributes?.year && (
                <div>
                  ...
                  <p className="detail-value">{item.attributes.year}</p>
                </div>
              )}
              {item.attributes?.license_plate && (
                <div>
                  <label className="detail-label">License Plate</label>
                  <p className="detail-value">{item.attributes.license_plate}</p>
                </div>
              )}
              {item.attributes?.vin && (
                <div>
                  <label className="detail-label">VIN</label>
                  <p className="detail-value">{item.attributes.vin}</p>
                </div>
              )}
            </div>
          </div>
      ...
      <div className="bottom-actions">
        ...
        <button
          type="button"
          onClick={() => router.push(`/supervisor/vehicles/${itemId}/edit`)}
